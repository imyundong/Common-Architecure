...
Public Class CBrokerPrSQLServer
    Inherits CBrokerPrStruct
    ...
    Public Sub Insert(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim StructObj As CBrokerPrStruct = TryCast(Obj, CBrokerPrStruct)

        Dim SQL As New Text.StringBuilder
        SQL.Append(" INSERT INTO BrokerPr ")
        SQL.Append("    ( ")
        SQL.Append("    [branchcd], ")
        SQL.Append("    [brokercd], ")
        SQL.Append("    [brokername]) ")
        SQL.Append(" VALUES ")
        SQL.Append("    ( ")
        SQL.Append("    @branchcd, ")
        SQL.Append("    @brokercd, ")
        ...
        Command.Parameters.AddWithValue("brokercd", StructObj.brokercd)
        Command.Parameters.AddWithValue("brokername", StructObj.brokername)
    ...
    Public Sub Update(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim SQL As New Text.StringBuilder
        SQL.Append(" UPDATE BrokerPr ")
        SQL.Append(" SET ")
        SQL.Append("     [brokername] = @brokername ")
        SQL.Append(" WHERE ")
        SQL.Append("     [branchcd] = @branchcd ")
        SQL.Append(" AND [brokercd] = @brokercd ")
    ...
    Public Sub Remove(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim SQL As New Text.StringBuilder
        SQL.Append(" DELETE FROM BrokerPr ")
        SQL.Append(" WHERE ")
        SQL.Append("     [branchcd] = @branchcd ")
        SQL.Append(" AND [brokercd] = @brokercd ")
    ...
    Public Sub Search(ByVal Adapter As IDatabaseAdapter, _
        ...
        If Not IsDBNull(Row(0).Item(1)) Then StructObj.brokercd = Row(0).Item(1)
        If Not IsDBNull(Row(0).Item(2)) Then StructObj.brokername = Row(0).Item(2)
    End Sub
    ...
    Public Sub SearchAll(ByVal Adapter As IDatabaseAdapter, _
        ...
        For Each Row As DataRow In Rows
            ...
            If Not IsDBNull(Row.Item(1)) Then StructObj.brokercd = Row.Item(1)
            If Not IsDBNull(Row.Item(2)) Then StructObj.brokername = Row.Item(2)
            DatabaseObj.Add(StructObj)
        Next
    End Sub

    Public Sub SearchgetBrokername(ByVal Adapter As IDatabaseAdapter, _
                                      ByVal Obj As CBrokerPrStruct, _
                                      ByRef BrokerPrList As List(Of Object), _
        ...
        For Idx As Integer = 0 To Data.Tables(0).Rows.Count - 1
            Dim DBStruct As New CBrokerPrStruct

            If Not IsDBNull(Row(Idx).Item(0)) Then DBStruct.branchcd = Row(Idx).Item(0)
            If Not IsDBNull(Row(Idx).Item(1)) Then DBStruct.brokercd = Row(Idx).Item(1)
            If Not IsDBNull(Row(Idx).Item(2)) Then DBStruct.brokername = Row(Idx).Item(2)

            BrokerPrList.Add(DBStruct)
        Next
