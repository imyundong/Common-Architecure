...
' Description   : Table    OverrideStatus
'               : Database SQLServer
...
Public Class COverrideStatusSQLServer
    Inherits COverrideStatusStruct
    ...
    Public Sub Insert(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim StructObj As COverrideStatusStruct = TryCast(Obj, COverrideStatusStruct)

        Dim SQL As New Text.StringBuilder
        SQL.Append(" INSERT INTO OverrideStatus ")
        SQL.Append("    ( ")
        SQL.Append("    [OverrideStatusId], ")
        ...
        Command.Parameters.AddWithValue("OverrideStatusId", StructObj.OverrideStatusId)
    ...
    Public Sub Update(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim SQL As New Text.StringBuilder
        SQL.Append(" UPDATE OverrideStatus ")
        SQL.Append(" SET ")
        SQL.Append("     [Description] = @Description ")
        SQL.Append(" WHERE ")
        SQL.Append("     [OverrideStatusId] = @OverrideStatusId ")
    ...
    Public Sub Remove(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim SQL As New Text.StringBuilder
        SQL.Append(" DELETE FROM OverrideStatus ")
        SQL.Append(" WHERE ")
        SQL.Append("     [OverrideStatusId] = @OverrideStatusId ")
    ...
    Public Sub Search(ByVal Adapter As IDatabaseAdapter, _
        ...
        If Not IsDBNull(Row(0).Item(0)) Then StructObj.OverrideStatusId = Row(0).Item(0)
    ...
    Public Sub SearchAll(ByVal Adapter As IDatabaseAdapter, _
        ...
        For Each Row As DataRow In Rows
            ...
            If Not IsDBNull(Row.Item(0)) Then StructObj.OverrideStatusId = Row.Item(0)
    ...
    Public ReadOnly Property Name As String Implements IComponent.Name
        Get
            Return "SQLServer_OverrideStatus"
        End Get
    End Property
