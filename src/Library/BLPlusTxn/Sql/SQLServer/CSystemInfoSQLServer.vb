...
Public Class CSystemInfoSQLServer
    Inherits CSystemInfoStruct
    ...
    Public Sub Insert(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim StructObj As CSystemInfoStruct = TryCast(Obj, CSystemInfoStruct)

        Dim SQL As New Text.StringBuilder
        SQL.Append(" INSERT INTO SystemInfo ")
        SQL.Append("    ( ")
        SQL.Append("    [SystemId], ")
        ...
        Command.Parameters.AddWithValue("SystemName", StructObj.SystemName)
        Command.Parameters.AddWithValue("Version", StructObj.Version)
    ...
    Public Sub Update(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim SQL As New Text.StringBuilder
        SQL.Append(" UPDATE SystemInfo ")
        SQL.Append(" SET ")
        SQL.Append("     [SystemName] = @SystemName, ")
    ...
    Public Sub Remove(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim SQL As New Text.StringBuilder
        SQL.Append(" DELETE FROM SystemInfo ")
        SQL.Append(" WHERE ")
        SQL.Append("     [SystemId] = @SystemId ")
    ...
    Public Sub Search(ByVal Adapter As IDatabaseAdapter, _
        ...
        If Not IsDBNull(Row(0).Item(1)) Then StructObj.SystemName = Row(0).Item(1)
        If Not IsDBNull(Row(0).Item(2)) Then StructObj.Version = Row(0).Item(2)
    End Sub
    ...
    Public Sub SearchAll(ByVal Adapter As IDatabaseAdapter, _
        ...
        For Each Row As DataRow In Rows
            ...
            If Not IsDBNull(Row.Item(1)) Then StructObj.SystemName = Row.Item(1)
            If Not IsDBNull(Row.Item(2)) Then StructObj.Version = Row.Item(2)
