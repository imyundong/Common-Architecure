...
Public Class CPluginListSQLServer
    Inherits CPluginListStruct
    ...
    Public Sub Insert(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim StructObj As CPluginListStruct = TryCast(Obj, CPluginListStruct)

        Dim SQL As New Text.StringBuilder
        SQL.Append(" INSERT INTO PluginList ")
        SQL.Append("    ( ")
        SQL.Append("    [PluginId], ")
        SQL.Append("    [PluginName], ")
        SQL.Append("    [PluginFriendlyName], ")
        SQL.Append("    [PluginIcon]) ")
        SQL.Append(" VALUES ")
        SQL.Append("    ( ")
        SQL.Append("    @PluginId, ")
        SQL.Append("    @PluginName, ")
        ...
        Command.Parameters.AddWithValue("PluginName", StructObj.PluginName)
        Command.Parameters.AddWithValue("PluginFriendlyName", StructObj.PluginFriendlyName)
        Command.Parameters.AddWithValue("PluginIcon", StructObj.PluginIcon)
    ...
    Public Sub Update(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim SQL As New Text.StringBuilder
        SQL.Append(" UPDATE PluginList ")
        SQL.Append(" SET ")
        SQL.Append("     [PluginName] = @PluginName, ")
        SQL.Append("     [PluginFriendlyName] = @PluginFriendlyName, ")
        SQL.Append("     [PluginIcon] = @PluginIcon ")
        SQL.Append(" WHERE ")
        SQL.Append("     [PluginId] = @PluginId ")
    ...
    Public Sub Remove(ByVal Adapter As IDatabaseAdapter, ByRef Obj As Object) _
        ...
        Dim SQL As New Text.StringBuilder
        SQL.Append(" DELETE FROM PluginList ")
        SQL.Append(" WHERE ")
        SQL.Append("     [PluginId] = @PluginId ")
    ...
    Public Sub Search(ByVal Adapter As IDatabaseAdapter, _
        ...
        If Not IsDBNull(Row(0).Item(0)) Then StructObj.PluginId = Row(0).Item(0)
        If Not IsDBNull(Row(0).Item(1)) Then StructObj.PluginName = Row(0).Item(1)
        If Not IsDBNull(Row(0).Item(2)) Then StructObj.PluginFriendlyName = Row(0).Item(2)
        If Not IsDBNull(Row(0).Item(3)) Then StructObj.PluginIcon = Row(0).Item(3)
    End Sub
    ...
    Public Sub SearchAll(ByVal Adapter As IDatabaseAdapter, _
        ...
        For Each Row As DataRow In Rows
            ...
            If Not IsDBNull(Row.Item(0)) Then StructObj.PluginId = Row.Item(0)
            If Not IsDBNull(Row.Item(1)) Then StructObj.PluginName = Row.Item(1)
            If Not IsDBNull(Row.Item(2)) Then StructObj.PluginFriendlyName = Row.Item(2)
            If Not IsDBNull(Row.Item(3)) Then StructObj.PluginIcon = Row.Item(3)
