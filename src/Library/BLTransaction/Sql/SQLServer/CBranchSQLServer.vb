...
Public Class CBranchSQLServer
    ...
    Public Sub Search(ByVal Adapter As IDatabaseAdapter, _
        ...
        If Not IsDBNull(Row(0).Item(3)) Then StructObj.BranchCategoryId = Row(0).Item(3)
    End Sub
    ...
    Public Sub SearchAll(ByVal Adapter As IDatabaseAdapter, _
        ...
        For Each Row As DataRow In Rows
            ...
            If Not IsDBNull(Row.Item(3)) Then StructObj.BranchCategoryId = Row.Item(3)
            DatabaseObj.Add(StructObj)
        Next
    End Sub

    Public Sub SearchByParent(ByVal Adapter As IDatabaseAdapter, _
                                      ByVal Obj As CBranchStruct, _
                                      ByRef BranchList As List(Of Object), _
        ...
        For Idx As Integer = 0 To Data.Tables(0).Rows.Count - 1
            Dim DBStruct As New CBranchStruct

            If Not IsDBNull(Row(Idx).Item(0)) Then DBStruct.BranchId = Row(Idx).Item(0)
            If Not IsDBNull(Row(Idx).Item(1)) Then DBStruct.BranchName = Row(Idx).Item(1)
            If Not IsDBNull(Row(Idx).Item(2)) Then DBStruct.Parent = Row(Idx).Item(2)
            If Not IsDBNull(Row(Idx).Item(3)) Then DBStruct.BranchCategoryId = Row(Idx).Item(3)

            BranchList.Add(DBStruct)
        Next

    End Sub

    Public Sub SearchByBrahchIdGetName(ByVal Adapter As IDatabaseAdapter, _
                                      ByVal Obj As CBranchStruct, _
                                      ByRef BranchList As List(Of Object), _
                                      ByVal Lock As Boolean?) _
    ...
    Public Sub SearchByAll(ByVal Adapter As IDatabaseAdapter, _
                                      ByVal Obj As CBranchStruct, _
                                      ByRef BranchList As List(Of Object), _
                                      ByVal Lock As Boolean?) _
    ...
    Public Sub SearchByBranchCategoryId(ByVal Adapter As IDatabaseAdapter, _
                                      ByVal Obj As CBranchStruct, _
                                      ByRef BranchList As List(Of Object), _
                                      ByVal Lock As Boolean?) _
